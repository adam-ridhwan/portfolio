    ...
    <>
      ...
      <Card className='mx-4'>
        <CardContent className='flex flex-col'>
          ...
          <Badge variant='destructive' className='mb-2 w-max bg-cyan-800 text-white'>
            Blog website
          </Badge>
          ...
          <div className='mb-4 flex flex-col'>
            ...
            <span className='text-md font-light text-muted-foreground'>
              An interactive and responsive blogging platform where users can post articles. Features include
              the ability for readers to like, comment on, save, and delete posts.
            </span>
          </div>
