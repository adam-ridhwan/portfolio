    ...
    <>
      ...
      <div className='flex flex-col gap-8'>
        {projects.map(project => (
          <div key={project.name} className='mx-4'>
            <div className='mb-2'>
            ...
            <div className='mb-4 flex flex-col'>
              <span className='text-xl font-medium text-secondary-foreground'>{project.name}</span>
              <span className='text-md font-light text-muted-foreground'>{project.description}</span>
            </div>
          </div>
        ))}
      </div>
